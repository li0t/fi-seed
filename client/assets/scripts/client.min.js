...
!function(e){"use strict";function a(e){e.html5Mode(!0)}function n(e){e.useStaticFilesLoader({files:[{prefix:"/assets/locales/",suffix:".json"}]}),e.useSanitizeValueStrategy("escape"),e.preferredLanguage("en").fallbackLanguage("en")}function t(e){e.configure({templateUrl:"/assets/templates/main/flash.html"})}function i(a,n){a.app=e.app;var t=navigator&&navigator.language;r.string(t)&&t.length&&(t=t.substring(0,2)),n.use(t||"en")}var s=e.angular,r=e.is;s.module("App").config(["$translateProvider",n]).config(["$locationProvider",a]).config(["ngFlashesProvider",t]).run(["$rootScope","$translate",i])}(window);